...
class DualLogger:
    ...
    def info(self, *args, **kwargs):
        # Accept either a positional event string or an explicit
        # 'event' keyword to avoid duplicate-argument TypeError.
        if 'event' in kwargs:
            payload = kwargs
        else:
            event = args[0] if len(args) > 0 else ""
            payload = {**kwargs, 'event': event}
        self.file.info(**payload)
        self.console.info(**payload)
    ...
    def warning(self, *args, **kwargs):
        if 'event' in kwargs:
            ...
            event = args[0] if len(args) > 0 else ""
            payload = {**kwargs, 'event': event}
        self.file.warning(**payload)
        self.console.warning(**payload)
    ...
    def error(self, *args, **kwargs):
        if 'event' in kwargs:
            ...
            event = args[0] if len(args) > 0 else ""
            payload = {**kwargs, 'event': event}
        self.file.error(**payload)
        self.console.error(**payload)
    ...
    def debug(self, *args, **kwargs):
        if 'event' in kwargs:
            ...
            event = args[0] if len(args) > 0 else ""
            payload = {**kwargs, 'event': event}
        self.file.debug(**payload)
        self.console.debug(**payload)
    ...
    def critical(self, *args, **kwargs):
        if 'event' in kwargs:
            ...
            event = args[0] if len(args) > 0 else ""
            payload = {**kwargs, 'event': event}
        self.file.critical(**payload)
        self.console.critical(**payload)
